namespace DBidontwantgotothearmy
{
    ...
    "если будете удерживать нажатой [CTRL])";
            ...
            this.dateTimePicker2.Value = new System.DateTime(2022, 12, 23, 0, 0, 0, 0);
            // 
            // label4
            // 
            ...
            this.dateTimePicker1.Value = new System.DateTime(2022, 12, 23, 0, 0, 0, 0);
            // 
            // richTextBox1
            // 
            ...
            // sqlConnection1
            // 
            this.sqlConnection1.ConnectionString = "Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=\"C:\\Users\\Дима\\Desktop\\БД КУР" +
    "САЧ\\auction_db-master\\AukcionDB.mdf\";Integrated Security=True;Connect Timeout=30" +
    "";
